...
<div id="Octave"> {% comment %} Start of 'octave' section. {% endcomment %}
  <h3>GNU Octave</h3>
  <p>
    Octave is an interpreted computational language that is largely compatible with Matlab. It is free and available for Linux, Mac and Windows with installation instructions at the <a href="https://www.gnu.org/software/octave/#install">Download page</a>.
  </p>
</div> {% comment %} End of 'Octave' section. {% endcomment %}

<div id="sshfs"> {% comment %} Start of 'sshfs' section. {% endcomment %}
  <h3>SSHFS</h3>
  <p>
    SSHFS is a secure shell file system mount that facilitates viewing and interacting with remote file system on a local machine. It is free and available for Linux, Mac and Windows with installation instructions at <a href="https://www.digitalocean.com/community/tutorials/how-to-use-sshfs-to-mount-remote-file-systems-over-ssh">DigitalOcean</a>.
  </p>
</div> {% comment %} End of 'SSHFS' section. {% endcomment %}

<div id="Meld"> {% comment %} Start of 'meld' section. {% endcomment %}
  <h3>Meld</h3>
  <p>
    Meld is a difference viewer that provides intuitive and interactive file and directory comparison tools. It is free and available for Linux, Mac and Windows with installation instructions at the <a href="https://meldmerge.org/">home page</a>.
  </p>
</div> {% comment %} End of 'meld' section. {% endcomment %}
